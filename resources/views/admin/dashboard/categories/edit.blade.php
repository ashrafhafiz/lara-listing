                                    ...
                                    <div class="mb-4 form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <input id="category-slug" type="text" class="form-control" readonly
                                                placeholder="Category Slug..." name="slug" value="{{ $category->slug }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <label class="mt-2 custom-switch">
                                                <input type="checkbox" name="show_at_home" class="custom-switch-input"
                                                    {{ $category->show_at_home === 1 ? 'checked' : '' }}>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#icon_img-preview').css({
                'background-image': 'url({{ asset($category->icon_img) }})',
                'background-size': 'cover',
                'background-position': 'center center',
            });

            $('#bg_img-preview').css({
                'background-image': 'url({{ asset($category->bg_img) }})',
                'background-size': 'cover',
                'background-position': 'center center',
            })
        });
